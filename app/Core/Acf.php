...
class Acf
{
    ...
    private static function translate_string(string $value): string
    {
        ...
        $translations = [
            ...
            'Spacer Block' => 'Blok separatora',
            'Desktop settings' => 'Ustawienia desktop',
            'Desktop source' => 'Źródło dla desktop',
            'Theme scale' => 'Skala motywu',
            'Custom px' => 'Własna wartość px',
            'Desktop size' => 'Rozmiar desktop',
            'Desktop custom px' => 'Własna wartość desktop',
            'Mobile settings' => 'Ustawienia mobile',
            'Mobile source' => 'Źródło dla mobile',
            'Mobile size' => 'Rozmiar mobile',
            'Mobile custom px' => 'Własna wartość mobile',
